...
void CamadaEnlaceTransmissora (const vector<int>& quadro, int codificacaoFisica, int tipoDeEnquadramento) {
    vector<int> quadroEnquadrado = CamadaEnlaceTransmissoraEnquadramento(quadro, tipoDeEnquadramento);
    //CamadaEnlaceTransmissoraControleDeErro(quadroEnquadrado);
    CamadaFisicaTransmissora(quadroEnquadrado, codificacaoFisica, tipoDeEnquadramento);
}

vector<int> CamadaEnlaceTransmissoraEnquadramento (const vector<int>& quadro, int tipoDeEnquadramento) {
...
void CamadaEnlaceReceptora (const vector<int>& quadroEnquadrado, int tipoDeEnquadramento) {
    vector<int> quadro = CamadaEnlaceReceptoraEnquadramento(quadroEnquadrado, tipoDeEnquadramento);
    //CamadaEnlaceReceptoraControleDeErro(quadro);
    CamadaDeAplicacaoReceptora(quadro);
}

vector<int> CamadaEnlaceReceptoraEnquadramento (const vector<int>& quadroEnquadrado, int tipoDeEnquadramento) {
    //int tipoDeEnquadramento = 0;
    vector<int> quadro;

    switch(tipoDeEnquadramento) {
        case CONTAGEM_DE_CHAR: 
            quadro = CamadaEnlaceReceptoraEnquadramentoContagemDeCaracteres(quadroEnquadrado);
            break;
        case INSERCAO_DE_BYTE:
            quadro = CamadaEnlaceReceptoraEnquadramentoInsercaoDeBytes(quadroEnquadrado);
            break;
        default:
...
vector<int> CamadaEnlaceReceptoraEnquadramentoContagemDeCaracteres (vector<int> quadroEnquadrado) {
...
vector<int> CamadaEnlaceReceptoraEnquadramentoInsercaoDeBytes (vector<int> quadroEnquadrado) {
    vector<int> quadro = quadroEnquadrado;
    return quadro;
}
